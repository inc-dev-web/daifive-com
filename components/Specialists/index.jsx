			...
			<div className={'flex flex-col md:pr-[243px]'}>
				...
				<div className={'flex flex-col md:flex-row md:gap-[70px] gap-4 md:mt-[25px] mt-3 mb-20 md:mb-0'}>
					...
					<p className={'text-[#2A333CB2] font-normal md:leading-6 md:text-base text-sx flex-1'}>
						Наші фахівці - це не просто експерти у своїй справі; вони - серце нашого центру. З високим рівнем професіоналізму, глибокою емпатією та
						інноваційними підходами, вони створюють особливе середовище для розвитку кожної дитини
					</p>
				</div>
			</div>
