...
export function RemainingQuestions() {
	const items = [
		...
		},
		{
			...
			description: 'В першу чергу, ви маєте звернутись на загальну діагностичну консультацію до куратора Центру, на якій вас зорієнтують с чого вам почати взалежності від характеру порушень, та особлиовстей дитини.',
		},
		{
			title: 'Яка терапія краще?',
			description: 'Найкращим для вашої дитини буде відвідування різних спеціалістів. Тобто системне та мультидисциплінарне втручання, яке допоможе компенсувати та виправити всі дефіцити її розвитку. Це значить, що найкращим буде відвідувати різні терапії одночасно.',
		},
		{
			title: 'У вас групові чи індивідуальні зайняття?',
			description: 'Більшість наших занятть проходить індивідуально, але ми маємо і групові зайняття для дошкільнят, школярів та групи раннього розвитку.',
		},
		{
			title: 'До вас ходять тільки діти з аутизмом? ',
			description: `Ні. До нас звертаються діти з різними порушеннями психічного і мовленнєвого розвитку:\n\n- аутизм (всі різновидності)\n- РДУГ\n- Синдром Дауна\n- ДЦП\n- ЗМР\n- ЗПР\n- всі види логопедичних порушень (такі як дисграфія, дислексія, сенсорна та моторна алалія, дизартрія і т.п.)\n- діти, які мають проблеми з навчанням, соціалізацією і таке інше.`,
		},
	];
