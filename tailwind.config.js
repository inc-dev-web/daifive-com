	...
	theme: {
		extend: {
			...
			backgroundImage: {
				...
				bgContactUs: "url('/image/bgContactUs.png')",
				bg1ContactUs: "url('/image/bg1ContactUs.png')",
				bgMbContactUs: "url('/image/bgMbContactUs.png')",
				bg1MbContactUs: "url('/image/bg1MbContactUs.png')",
